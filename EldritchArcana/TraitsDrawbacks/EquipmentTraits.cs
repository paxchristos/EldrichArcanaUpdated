...
namespace EldritchArcana
{
    internal class EquipmentTraits
    {
        public static BlueprintFeatureSelection CreateEquipmentTraits()
        {
            ...
            var Greatclub = Traits.library.Get<BlueprintWeaponType>("1b8c24cd1f9358c48839bb39266468c3");
            var GreatclubPlus1 = Traits.library.Get<BlueprintItem>("41fdf5c9cb2dc0748ae4d71b6b5310a4");
            ...
            //131
            var Starknife = Traits.library.Get<BlueprintWeaponType>("5a939137fc039084580725b2b0845c3f");
            var StarknifePlus1 = Traits.library.Get<BlueprintItem>("bacea00ed10657043bf90641eeabde95");
            var LightMace = Traits.library.Get<BlueprintWeaponType>("cf3e703db4b81904e982a66d7b8474ea");
            var LightMacePlus1 = Traits.library.Get<BlueprintItem>("5fe90cd1d77d8f446ac955dec7c8759f");
            var Bardiche = Traits.library.Get<BlueprintWeaponType>("b1cbf457fd471d148b39ae56667f405a");
            var BardichePlus1 = Traits.library.Get<BlueprintItem>("cc02b827bf9f80a449b464fe06027b2c");
            var Battleaxe = Traits.library.Get<BlueprintWeaponType>("2bc77aa47f97de348aefcf03ec8fa43b");
            var BattleaxePlus1 = Traits.library.Get<BlueprintItem>("0ce4b3f4a3d70fa45851313a7f3d233f");
            var Blowgun = Traits.library.Get<BlueprintWeaponType>("1995657081e66a44c86af1c4b42f1643");
            var BlowgunPlus1 = Traits.library.Get<BlueprintItem>("e063bcb91f062b449a1eb8fbd2fd64b6");
            var Bola = Traits.library.Get<BlueprintWeaponType>("43b5223f626dbb84b966d15ee2c294f2");
            var BolaPlus1 = Traits.library.Get<BlueprintItem>("0dddc87a06d822b4ea5e57b128003ce3");
            //132
            //greataxe requested
            var Greataxe = Traits.library.Get<BlueprintWeaponType>("e8059a8eac62cd74f9171d748a5ae428");
            var GreataxePlus1 = Traits.library.Get<BlueprintItem>("4f0704c1d4d53cf419bd200bdfc12a0a");
            var CompositeShortbow = Traits.library.Get<BlueprintWeaponType>("011f6f86a0b16df4bbf7f40878c3e80b");
            var CompositeShortbowPlus1 = Traits.library.Get<BlueprintItem>("eec59da36fadf594aac6bd9add90652e");
            
            //133
            //CompositeShortbowPlus1.type
            var HeirloomWeaponGuidlist = new string[70];
            String baseguid = "a3a5ccc9c670e6c4ca4a686d23";
            x = 0;
            for (long i = 29999; i < 30069; i++)
            {
                HeirloomWeaponGuidlist[x] = baseguid + i.ToString();
                x++;
            }

            var HeirloomWeapontypesguidfeaturelist = new string[]
            {
                "f415ae950523a7843a74d7780dd551af",//Dart.
                "87d76c7534506a546a065731ee6a38cd",//DoubleAxe.
                "e95efb85a0912a7489be69d5f03a5308",//DoubleSword.
                "0ec97c08fdf87e44f8f16ba87b511743",//DwarvenUrgrosh.
                //"c4e95e3c489721e4382fd8514a522f9d",//DwarvenUrgroshSpearHead.
            };



            var HeirloomWeaponguidfeaturelist = new string[]
            {
                "9a237496e6b3898498da4a2ecd9ed660",//Dart.DartPlus1.
                "acf57e1471b5b1d40893c2f3186e49fa",//StandardDoubleAxePlus1.
                "4cef4996de4ea264fa2194031d74cc7e",//StandardDoubleSwordSecondPlus1.
                "924b5edb3e09b2c4fbeb314b070b9eeb",//StandardDwarvenUrgroshPlus1. //"924b5edb3e09b2c4fbeb314b070b9eeb",//StandardDwarvenUrgroshPlus1.
                //"",//cannot find
            };
            ...
            var HeirloomWeapons = new List<BlueprintFeature>()
            {
                
                //compshortbow
                Helpers.CreateFeature("HairloomTraitComBow", "Family Heirloom Composite Shortbow",
                "You like bows but you think longbows are to clunky so you use a composite shortbow." +
                "\nBenefit: You can shoot better with composite shortbows.",
                HeirloomWeaponGuidlist[5],
                CompositeShortbowPlus1.Icon,
                FeatureGroup.None,Helpers.Create<AddStartingEquipment>(a =>
                {
                    a.CategoryItems = Array.Empty<WeaponCategory>();
                    a.RestrictedByClass = Array.Empty<BlueprintCharacterClass>();
                    a.BasicItems = new BlueprintItem[] { CompositeShortbowPlus1 };
                }),
                Helpers.Create<WeaponAttackAndCombatManeuverBonus>(a => { a.WeaponType = CompositeShortbow; a.AttackBonus = 1; a.Descriptor = ModifierDescriptor.Trait;})
                ),


                //Greataxe
                Helpers.CreateFeature("HairloomTraitGreataxe", "Family Heirloom Greataxe",
                "How could anyone not love a greataxe your family cetainly does." +
                "\nBenefit: You fight better with Greataxe's.",
                HeirloomWeaponGuidlist[4],
                GreataxePlus1.Icon,
                FeatureGroup.None,Helpers.Create<AddStartingEquipment>(a =>
                {
                    a.CategoryItems = Array.Empty<WeaponCategory>();
                    a.RestrictedByClass = Array.Empty<BlueprintCharacterClass>();
                    a.BasicItems = new BlueprintItem[] { GreataxePlus1 };
                }),
                Helpers.Create<WeaponAttackAndCombatManeuverBonus>(a => { a.WeaponType = Greataxe; a.AttackBonus = 1; a.Descriptor = ModifierDescriptor.Trait; })
                ),

                //bola
                Helpers.CreateFeature("HairloomTraitBola", "Family Heirloom Bola",
                "The bola your mother used for catching deer in the woods is now your faithfull weapon." +
                "\nBenefit: You fight better with bola's.",
                HeirloomWeaponGuidlist[3],
                BolaPlus1.Icon,
                FeatureGroup.None,Helpers.Create<AddStartingEquipment>(a =>
                {
                    a.CategoryItems = Array.Empty<WeaponCategory>();
                    a.RestrictedByClass = Array.Empty<BlueprintCharacterClass>();
                    a.BasicItems = new BlueprintItem[] { BolaPlus1 };
                }),
                Helpers.Create<WeaponAttackAndCombatManeuverBonus>(a => { a.WeaponType = Bola; a.AttackBonus = 1; a.Descriptor = ModifierDescriptor.Trait; })
                ),

                //blowgun
                Helpers.CreateFeature("HairloomTraitBlowgun", "Family Heirloom Blowgun",
                "You use an old blowgun your family bought as a souvenir while they where visiting a tribe." +
                "\nBenefit: You fight better with blowgun's.",
                HeirloomWeaponGuidlist[2],
                BlowgunPlus1.Icon,
                FeatureGroup.None,Helpers.Create<AddStartingEquipment>(a =>
                {
                    a.CategoryItems = Array.Empty<WeaponCategory>();
                    a.RestrictedByClass = Array.Empty<BlueprintCharacterClass>();
                    a.BasicItems = new BlueprintItem[] { BlowgunPlus1 };
                }),
                Helpers.Create<WeaponAttackAndCombatManeuverBonus>(a => { a.WeaponType = Blowgun; a.AttackBonus = 1; a.Descriptor = ModifierDescriptor.Trait; })
                ),

                //battleaxe
                Helpers.CreateFeature("HairloomTraitBattleAxe", "Family Heirloom Battleaxe",
                "You start your adventure with an Axe that is made for chopping humans." +
                "\nBenefit: You fight better with battleaxe's.",
                HeirloomWeaponGuidlist[1],
                BattleaxePlus1.Icon,
                FeatureGroup.None,Helpers.Create<AddStartingEquipment>(a =>
                {
                    a.CategoryItems = Array.Empty<WeaponCategory>();
                    a.RestrictedByClass = Array.Empty<BlueprintCharacterClass>();
                    a.BasicItems = new BlueprintItem[] { BattleaxePlus1 };
                }),
                Helpers.Create<WeaponAttackAndCombatManeuverBonus>(a => { a.WeaponType = Battleaxe; a.AttackBonus = 1; a.Descriptor = ModifierDescriptor.Trait; })
                ),

                //LightMace
                Helpers.CreateFeature("HairloomTraitLightMace", "Family Heirloom Light Mace",
                "You start your adventure with this mace your father gave you." +
                "\nBenefit: You fight better with mace's.",
                HeirloomWeaponGuidlist[0],
                LightMacePlus1.Icon,
                FeatureGroup.None,Helpers.Create<AddStartingEquipment>(a =>
                {
                    a.CategoryItems = Array.Empty<WeaponCategory>();
                    a.RestrictedByClass = Array.Empty<BlueprintCharacterClass>();
                    a.BasicItems = new BlueprintItem[] { LightMacePlus1 };
                }),
                Helpers.Create<WeaponAttackAndCombatManeuverBonus>(a => { a.WeaponType = LightMace; a.AttackBonus = 1; a.Descriptor = ModifierDescriptor.Trait; })
                ),

                //bardiche
                Helpers.CreateFeature("HairloomTraitBardiche", "Family Heirloom Bardiche",
                "You inherited this bardiche from your father who was a royal palice guard." +
                "\nBenefit: You fight better with bardiche's.",
                "e16eb56b2f964313a30076226dccb392",
                BardichePlus1.Icon,
                FeatureGroup.None,Helpers.Create<AddStartingEquipment>(a =>
                {
                    a.CategoryItems = Array.Empty<WeaponCategory>();
                    a.RestrictedByClass = Array.Empty<BlueprintCharacterClass>();
                    a.BasicItems = new BlueprintItem[] { BardichePlus1 };
                }),
                Helpers.Create<WeaponAttackAndCombatManeuverBonus>(a => { a.WeaponType = Bardiche; a.AttackBonus = 1; a.Descriptor = ModifierDescriptor.Trait; })
                ),
                ...
                Helpers.CreateFeature("HairloomTraitGreatclub", "Family Heirloom Greatclub",
                "You take the greatclub your grandpa took off a killed troll" +
                "\nBenefit: You get a greatclub and you have experience with clubs.",
                "d05bd56b2d721524d33186226adcd191",
                GreatclubPlus1.Icon,
                FeatureGroup.None, Helpers.Create<AddStartingEquipment>(a =>
                {
                    a.CategoryItems = Array.Empty<WeaponCategory>();
                    a.RestrictedByClass = Array.Empty<BlueprintCharacterClass>();
                    a.BasicItems = new BlueprintItem[] { GreatclubPlus1 };
                }),
                Helpers.Create<WeaponAttackAndCombatManeuverBonus>(a => { a.WeaponType = Greatclub; a.AttackBonus = 1; a.Descriptor = ModifierDescriptor.Trait; })
                ),
                ...
                //starknife
                Helpers.CreateFeature("HairloomTraitStarknife", "Family Heirloom Starknife",
                "Your family worships Desna and becouse of this you have a few starknives at home. you where allowed to take the best one along on your adventure" +
                "\nBenefit: You are practiced with shortswords.",
                "e15eb14b2f964321b32196326ddcb393",
                StarknifePlus1.Icon, // DuelingMastery
                FeatureGroup.None,Helpers.Create<AddStartingEquipment>(a =>
                {
                    a.CategoryItems = Array.Empty<WeaponCategory>();
                    a.RestrictedByClass = Array.Empty<BlueprintCharacterClass>();
                    a.BasicItems = new BlueprintItem[] { StarknifePlus1 };
                }),
                Helpers.Create<WeaponAttackAndCombatManeuverBonus>(a => { a.WeaponType = Starknife; a.AttackBonus = 1; a.Descriptor = ModifierDescriptor.Trait; })
                ),
                //

            };

            for (int i = 0; i < HeirloomWeaponguidfeaturelist.Length; i++)
            {

                var Weapontype= Traits.library.Get<BlueprintWeaponType>(HeirloomWeapontypesguidfeaturelist[i]);
                var WeaponPlus1 =  Traits.library.Get<BlueprintItem>(HeirloomWeaponguidfeaturelist[i]);

                var Heirloomtraitweapon = Helpers.CreateFeature($"HairloomTrait{WeaponPlus1.Name}", $"Family Heirloom {WeaponPlus1.Name}",
                $"You have inherited a: {WeaponPlus1.Name}" +
                $"\nBenefit: You get a {WeaponPlus1.Name} and have +1 on attack rolls when attacking with weapons of this type.",
                HeirloomWeaponGuidlist[i + 35],
                WeaponPlus1.Icon,
                FeatureGroup.None, Helpers.Create<AddStartingEquipment>(a =>
                {
                    a.CategoryItems = Array.Empty<WeaponCategory>();
                    a.RestrictedByClass = Array.Empty<BlueprintCharacterClass>();
                    a.BasicItems = new BlueprintItem[] { WeaponPlus1 };
                }),
                Helpers.Create<WeaponAttackAndCombatManeuverBonus>(a => { a.WeaponType = Weapontype; a.AttackBonus = 1; a.Descriptor = ModifierDescriptor.Trait; })
                );

                HeirloomWeapons.Add(Heirloomtraitweapon);
